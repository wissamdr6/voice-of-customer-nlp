...
| Capability | Details |
|---|---|
| 🔍 Sentiment Analysis | global & aspect-based |
| 🧩 Aspect Extraction | token classification (BIO) |
| ⚡ Topic Modeling | BERTopic / KeyBERT |
| 📊 Trend Analysis | time-based KPIs |
| 🧪 Model Training | Transformers + PyTorch |
| 🧬 Production Serving | FastAPI REST API |
| 📦 Containerized | Docker |
| 🧭 Monitoring | drift, sentiment trends, topic evolution |
